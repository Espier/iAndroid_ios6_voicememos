...
public class MemoEdit extends BaseUi implements OnClickListener,
    ...
    private OnTouchListener movingEventListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (v == mStartView) {
                    if (left < mMarginLeft) {
                        Log.d("prb1", "left:" + left + "mMarginLeft:"
                                + mMarginLeft);
            ...
            case MotionEvent.ACTION_UP:
                mStartOffset = mStrenchView.getLeft() - mMarginLeft
                        - mStartView.getWidth();
                mEndOffset = mStrenchView.getRight() - mMarginLeft
                        - mStartView.getWidth();
