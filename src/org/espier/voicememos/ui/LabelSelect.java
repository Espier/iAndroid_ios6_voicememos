    ...
    private void updateVoiceMemo(int labelType, String labelName) {
        ...
        if (memoId != -1) {
            Uri memoUri = ContentUris.withAppendedId(
                    VoiceMemo.Memos.CONTENT_URI, memoId);
            ...
            if (convertView == null) {
                ...
                if (position == CUSTOM_LABEL_INDEX) {
                    ...
                    iv.setOnClickListener(new OnClickListener() {
                        ...
                        @Override
                        public void onClick(View v) {
                            Intent customIntent = new Intent(LabelSelect.this,
                                    LabelCustom.class);
                            ...
                            startActivityForResult(customIntent,
                                    CUSTOM_LABEL_INTENT);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == CUSTOM_LABEL_INTENT) {
                ...
                String labelName = data
                        .getStringExtra(LabelCustom.CUSTOM_LABEL_NAME);
