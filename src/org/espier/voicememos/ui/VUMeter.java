...
public class VUMeter extends View {
    ...
    void init(Context context) {
        Drawable background = context.getResources().getDrawable(R.drawable.main_vu);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float minAngle = (float)Math.PI*1.5f/7;
        final float maxAngle = (float)Math.PI*5.5f/7;
