...
public class MemoMain extends BaseUi implements OnClickListener,
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case UPDATE_TIMER:
                ...
                mRecordTimeView.setText(timePrefix + " "
                        + recordTime);
    ...
    public void onClick(View view) {
        ...
        case R.id.start_record:
            ...
            if (mRecorder.getState() == Recorder.RECORDING_STATE) {
                ...
                mStartRecordView
                        .setImageResource(R.drawable.main_record_selector);
            } else {
                ...
                mStartRecordView
                        .setImageResource(R.drawable.main_pause_selector);
            }
        ...
        case R.id.list_record:
            if (mRecorder.getState() == Recorder.IDLE_STATE) {
                ...
                insertVoiceMemo();
                ((ImageView) view)
                        .setImageResource(R.drawable.main_list_selector);
                mStartRecordView
                        .setImageResource(R.drawable.main_record_selector);
            }
            ;
    ...
    private void insertVoiceMemo() {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat(res
