...
/**
 * Provides access to a database of Memos. Each memo has a title, the memo
...
public class MemosProvider extends ContentProvider {
    ...
    private static HashMap<String, String> buildColumnMap() {
        ...
        map.put(VoiceMemo.Memos.MODIFICATION_DATE,
                VoiceMemo.Memos.MODIFICATION_DATE);
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
         ...
         * taken from the memoPad class.
         */
        @Override
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + VoiceMemo.Memos.TABLE_NAME + " ("
                    + VoiceMemo.Memos._ID + " INTEGER PRIMARY KEY,"
                    + VoiceMemo.Memos.DATA + " TEXT,"
                    + VoiceMemo.Memos.CREATE_DATE + " INTEGER,"
                    + VoiceMemo.Memos.LABEL_TYPE + " INTEGER,"
                    + VoiceMemo.Memos.DURATION + " INTEGER,"
                    + VoiceMemo.Memos.LABEL + " TEXT,"
                    + VoiceMemo.Memos.MODIFICATION_DATE + " INTEGER" + ");");
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        /*
         * If the incoming URI is for a single memo identified by its ID,
         * chooses the memo ID projection, and appends "_ID = <memoID>" to the
         * where clause, so that it selects that single memo
         */
        case MEMO_ID:
            qb.setProjectionMap(sMemosProjectionMap);
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (rowId > 0) {
            ...
            Uri memoUri = ContentUris.withAppendedId(
                    VoiceMemo.Memos.CONTENT_ID_URI_BASE, rowId);
     ...
     * Deletes records from the database. If the incoming URI matches the memo
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        case MEMO_ID:
            /*
             * Starts a final WHERE clause by restricting it to the desired memo
             * ID.
             */
     ...
     * the map. If the incoming URI matches the memo ID URI pattern, then the
