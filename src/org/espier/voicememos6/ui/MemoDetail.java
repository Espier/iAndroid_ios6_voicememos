...
public class MemoDetail extends BaseUi implements OnClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (cursor != null) {
      ...
      int durationIdx = cursor.getColumnIndexOrThrow(VoiceMemo.Memos.DURATION);
      int createDateIdx = cursor.getColumnIndexOrThrow(VoiceMemo.Memos.CREATE_DATE);
      ...
      if (cursor.moveToFirst()) {
        ...
        String dd = getString(R.string.record_time_prefix) + " " + format.format(d);
